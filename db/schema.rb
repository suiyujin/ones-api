...
ActiveRecord::Schema.define(version: 20150531021842) do
  ...
  create_table "battles", force: :cascade do |t|
    t.integer  "article1_id", limit: 4,             null: false
    t.integer  "article2_id", limit: 4,             null: false
    t.integer  "vote1_num",   limit: 4, default: 0
    t.integer  "vote2_num",   limit: 4, default: 0
    t.datetime "created_at",                        null: false
    t.datetime "updated_at",                        null: false
  end
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string   "profile_image_path",     limit: 255, default: "http://otakku-no1.herokuapp.com/images/dummy_user.jpg"
